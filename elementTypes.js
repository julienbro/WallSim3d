const elementTypes = {
    ...
    "Brique_19": { name: "Brique 19cm", dim: [19, 19, 19], color: 0xCC6633 },
    "Brique_14": { name: "Brique 14cm", dim: [14, 19, 19], color: 0xCC6633 },
    "Brique_9": { name: "Brique 9cm", dim: [9, 19, 19], color: 0xCC6633 },
    "Brique_4": { name: "Brique 4cm", dim: [4, 19, 19], color: 0xCC6633 }
};
