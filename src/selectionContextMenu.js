...
import { currentTool, moveState, selectedElement, elementForContextMenu, originalMovePosition, placedElements, objectsToRaycast } from './stateVariables.js';
import { updateUIToolStates, updateInfoText, updateCursor } from './toolUIManager.js';
import { raycaster, pointer, camera, renderer, contextMenu } from './threeSetup.js';
import { triggerMove, triggerDuplicate, deleteSelectedElement, rotateSelectedElement } from './elementActions.js';
 ...
 */
export function selectElement(elementData, keepContextMenuOpen = false) {
 ...
 */
export function showContextMenu(event, elementData) {
...
export function handleClickOutsideContextMenu(event) {
...
export function handleContextMenuRotate() {
...
export function handleContextMenuMove() {
    if (elementForContextMenu) {
...
export function handleContextMenuDuplicate() {
    if (elementForContextMenu) {
...
export function handleContextMenuDelete() {
    if (elementForContextMenu) {
